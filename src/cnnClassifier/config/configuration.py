...
class ConfigurationManager:
    ...
    def get_training_config(self) -> TrainingConfig:
            ...
            params = self.params
            training_data = os.path.join(self.config.data_ingestion.unzip_dir, "chest-xray-pneumonia/chest_xray/train")
            create_directories([
    ...
    def get_validation_config(self) -> EvaluationConfig:
        eval_config = EvaluationConfig(
            ...
            training_data=Path("artifacts/data_ingestion/chest-xray-pneumonia/chest_xray/train"),
